...
<html>
<head>
	<title> Essentials: Search Results</title>
...
<nav class="navbar navbar-expand-sm navbar-dark bg-nav animated fadeInDown">
		<div class="container">
			...
			<div class="search-box">
            	<form action = "searchessentialsresult.php" method="POST" class = "search-bar" autocomplete = "off">
...
<br>
    <?php
        ...
        $query = "Select * FROM products WHERE status = 'On Sale' AND category_id = 3" ;
