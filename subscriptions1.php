...
<nav class="navbar navbar-expand-sm navbar-dark bg-nav animated fadeInDown">
		<div class="container">
            ...
            <form action = "searchresult_catgry.php?catgid=<?php echo 6; ?>" method="POST">
...
<br><br><br>
    ...
    <?php
    $query1 = "select * from products where status = 'On Sale' and category_id = 6 ORDER BY pro_id DESC;";
